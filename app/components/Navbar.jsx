...
useEffect(()=>{
  ...
  return <>
  <div
   className=' flex mx-1.5 md:mx-0 md:justify-start lg:justify-center items-center'>
  <div
  //  className='w-full max-w-96 lg:max-w-7xl h-10  flex  justify-between lg:md:p-3  items-center py-6'
  className='fixed z-100 top-0  w-full
          max-w-[380px]
          md:max-w-[820px]
          lg:max-w-[1400px]
 h-10 flex justify-between md:flex  lg:flex md:justify-between lg:justify-around items-center  lg:p-1 md:px-2 py-3 lg:py-10 md:py-6 bg-white/90 md:border-none md:rounded-none border border-gray-500 rounded-lg '
   >
  <div 
